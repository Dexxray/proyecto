...
<!--Framework gratuito de bootstrap modificado por Javier Casco Rodes-->
    <head>
        ...
        <link href="estilos/estilo_index.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Bienvenido a Forodex</div>
                <div class="masthead-heading text-uppercase">En que consiste esta pagina</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Pulsame</a>
            </div>
        </header>
        <!-- Inicio-->
